                ...
                for __,v in pairs(player:GetDescendants()) do
                    if v:IsA("Tool") and table.find(CrashGears, v.Name) then
                        ...
                        if v.Name == "OrinthianSwordAndShield" then
                            send("ungear " .. nm, "removelimbs " .. nm, "refresh " .. nm, "pm " .. nm .. " [π]\nSorry, you can't use this gear right now. \n\n\n")
                        else
                            send("punish " .. nm, "unsize " .. nm,  "unpunish " .. nm, "pm " .. nm .. " [π]\nSorry, you can't use this gear right now. \n\n\n")
                        end
                    end
                end
            end
...
addCommand({
    ...
    Function = function(keyword)
        ...
        send("h \n\n\n\n \n\n\n\n[π] Found " .. #returnables .. " songs. \n\n\n\n")

        for _,v in pairs(returnables) do
            if stop then break end
            local skip = false
            send("music " .. v.Id)
            send("h \n\n\n [π] Now playing: " .. v.Title .. " (" .. v.Duration .. "s) \n\n\n")
